import { ChevronDown, ChevronLeft, ChevronRight, GraduationCap, LayoutDashboard, LogOut, MapPin, Menu, Users, X } from 'lucide-react';
...
const PrincipalDashboardLayout = () => {
  ...
  const tabs = [
    { name: "Dashboard", icon: LayoutDashboard, label: "Dashboard", path: "/principal/dashboard" },
    {
      name: "ManageTeachers",
      icon: GraduationCap,
      ...
      subItems: [
        { label: "Manage Teachers", path: "/principal/teachers/manage" },
        { label: "Create New Teacher", path: "/principal/teachers/create" }
      ]
    },
    {
      name: "ManageStudents",
      ...
      subItems: [
        { label: "Manage Students", path: "/principal/students/manage" },
        { label: "Add Student", path: "/principal/students/create" }
      ]
    },
  ];
