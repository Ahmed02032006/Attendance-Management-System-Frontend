...
const AdminTeacherAttendance_Page = () => {
  ...
  const filteredTeachers = searchTerm
    ...
    : teacherList.slice(0, 5); // Show first 5 teachers by default
  ...
  const handleSelectTeacher = (teacher) => {
    ...
    // Remove the slice(0, 7) to show all records
        ...
        <div className="bg-white rounded-lg p-4 mb-3 border-gray-200 border" ref={searchRef}>
          <div className="flex flex-col md:flex-row gap-4 items-end">
            <div className="flex-1 w-full relative">
              <label htmlFor="search" className="block text-sm font-medium text-gray-700 mb-1">Search Teachers</label>
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="flex items-center mt-1">
                              <p className="text-xs text-gray-500 truncate mr-2">{teacher.department}</p>
                              <span className="text-xs px-1.5 py-0.5 bg-sky-50 text-sky-700 rounded-full">
                                {teacher.teacherId || 'ID N/A'}
                              </span>
                            </div>
                          </div>
                          <div className="ml-2 flex flex-col items-end">
                            ...
                            <span className="text-xs mt-1 text-gray-500">
                              {teacher.attendance?.length || 0} records
                            </span>
                          </div>
                        </div>
                      ))
        ...
        {selectedTeacher ? (
                      ...
                      <div>
                        ...
                        <div className="flex items-center mt-1 space-x-2">
                          ...
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                            ID: {selectedTeacher.teacherId || 'N/A'}
                          </span>
                        </div>
                      </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Search for a teacher using the search bar above to view attendance records
            </p>
          </div>
        )}
      </main>
