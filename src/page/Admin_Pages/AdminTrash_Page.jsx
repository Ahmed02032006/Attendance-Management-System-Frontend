        ...
        <div className="text-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <FiTrash2 className="h-8 w-8 text-blue-600 animate-pulse" />
            </div>
          </div>
          <p className="mt-6 text-lg font-medium text-gray-700">Loading Recycle Bin...</p>
          <p className="mt-2 text-sm text-gray-500">Restoring deleted items</p>
        </div>
      </div>
    );
  }
