  ...
  return (
    <div className="min-h-screen bg-gray-50">
                      ...
                      >
                        <div className="flex items-center space-x-3 flex-1 min-w-0">
                          ...
                          <div className="min-w-0 flex-1">
                            <p
                              className={`text-xs font-medium truncate ${selectedSubject === subject.id ? 'text-blue-700' : 'text-gray-900'
                                }`}
                              title={subject.name}
                            >
                              {subject.name}
                        ...
                        <div className="text-right shrink-0 ml-2">
                          <p className={`text-sm font-medium ${selectedSubject === subject.id ? 'text-blue-700' : 'text-gray-900'
                            }`}>
                            {subject.students || 0}
                          </p>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-105"
      ...
      {isChatOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-80 sm:w-96 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div className="bg-blue-600 px-4 py-3 flex items-center justify-between">
            ...
            <button
              onClick={clearChat}
              className="text-blue-100 hover:text-white p-2 rounded-full hover:bg-blue-700 transition-colors"
          ...
          <div className="border-t border-gray-200 p-3">
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg p-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
